 ...
 <p style="font-size:16px; color:red" align="center"> <?php if($msg){
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-6">
        <div class="form-label-group">
          <select id="topwear" name="topwear" class="form-control" required="required">
            <option value="">Select Topwear(Tshirt, Top, Shirt)</option>
  ...
  <div class="form-group">
  <div class="form-label-group">
    <select id="bottomwear" name="bottomwear" class="form-control" required="required">
...
<div class="form-group">
  <div class="form-row">
    <div class="col-md-12">
      <div class="form-label-group">
        <select id="woolencloth" name="woolencloth" class="form-control" required="required">
          <option value="">Select Woolen Cloth</option>
          <option value="Sweater">Sweater</option>
          <option value="Cardigan">Cardigan</option>
          <option value="Coat">Coat</option>
        </select>
        <!-- <label for="woolencloth">Woolen Cloth</label> -->
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-md-12">
      <div class="form-label-group">
        <select id="others" name="others" class="form-control" required>
          ...
          <option value="mosq net">mosq net</option>
